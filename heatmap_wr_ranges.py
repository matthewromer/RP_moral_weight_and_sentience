...
def heatmap_wr_ranges(data1, data2, animal1, animal2, xlims, ylims, a1_mean,
                      a2_mean, correlation_coeff, title_str, text_loc,
                      num_bins=20, print_en=False, lims=[0, 2]):
    ...
    plt.text(text_loc[0], text_loc[1],
             'Mean ({}) = {} \nMean ({}) = {} \nCorrelation = {}'
             .format(animal1, a1_mean, animal2, a2_mean, correlation_coeff))
